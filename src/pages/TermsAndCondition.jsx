  ...
  return (
    <>
      ...
      <div>
        ...
        <h3 className="pl-4">1.1. Agreement to Terms</h3>
        <p className="pl-4">
          ...
          (&quot;Terms&quot;). These Terms have the same legal effect as a
          written agreement. If you do not agree to these Terms, you are
          prohibited from using the outworkx platform or Venues.
        </p>
        <h3 className="mt-2 pl-4">1.2. Amendment of Terms</h3>
        <p className="pl-4">
        ...
        <h3 className="mt-2 pl-4">1.3. Additional Terms</h3>
        <p className="pl-4">
        ...
        <h3 className="mt-2 pl-4">1.4. Incorporation of Privacy Policy</h3>
        <p className="pl-4">
        ...
        <h3 className="mt-2 pl-4">1.5. Additional References</h3>
        <p className="pl-4">
        ...
        <ul className="pl-6">
          ...
          <li>
            <span className="text-black">1.5.2 Cookie Notice:</span>
            (to be provided by outworkx - outlines information about cookies
            used on the platform)
          </li>
        </ul>
      </div>
      <div>
        <h2>2. Outworkx Platform</h2>

        <h3 className="pl-4">2.1. Access and Use</h3>

        <h4 className="pl-6">2.1.1. Grant of Access</h4>
        <p className="pl-6">
          ...
          made available through outworkx (collectively known as
          &quot;Listings&quot; or &quot;Venues&quot;) solely for your personal,
          non-commercial use and in accordance with these Terms.
        </p>

        <h4 className="pl-6">2.1.2. Third-Party Venues</h4>
        <p className="pl-6">
          ...
          (&quot;Venues&quot;). outworkx itself does not own, operate, or
          control any of the Venues listed on the Platform.
        </p>

        <h4 className="pl-6">2.1.3. Online and Offline Access</h4>
        <p className="pl-6">
        ...
        <h3 className="mt-3 pl-4">2.2. Membership Options</h3>

        <h4 className="pl-6">2.2.1. Subscription Plans</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.2.2. Promotional Plans</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.2.3. Non-Membership Purchases</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.2.4. Modification of Options</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.2.5. Non-Subscriber Access</h4>
        <p className="pl-6">
        ...
        <h3 className="mt-3 pl-4">2.3. Venue Availability</h3>

        <h4 className="pl-6">2.3.1. Subscription Package</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.3.2. Credit System</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.3.3. Right to Modify Availability</h4>
        <p className="pl-6">
          outworkx reserves the right to change the following at any time:
        </p>
        <ul className="pl-8">
          <li>a) The total number of Venues available on the Platform.</li>
          <li>b) The number of credits included in each subscription plan.</li>
          <li>c) The number of reservations a user can make.</li>
          <li>
            d) The number of Venues a user can visit within a given timeframe.
          </li>
        </ul>

        <h4 className="mt-2 pl-6">2.3.4. Availability Disclaimer</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.3.5. Allocation and Availability</h4>
        <p className="pl-6">
        ...
        <h3 className="mt-3 pl-4">2.4. Non-Subscription Purchases</h3>

        <h4 className="pl-6">2.4.1. In addition to subscriptions</h4>
        <p className="pl-6">
        ...
        <h4 className="mt-1 pl-6">2.4.2. Co-Memberships</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.4.3. Co-Membership Terms</h4>
        <p className="pl-6">
        ...
        <h3 className="mt-3 pl-4">2.5. Third-Party Venue Disclaimer</h3>

        <h4 className="pl-6">2.5.1. Third-Party Venue Disclaimer</h4>
        <p className="pl-6">
        ...
        <h3 className="pl-4">2.6. outworkx Account</h3>

        <h4 className="pl-6">2.6.1. Personal Use Only</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.6.2. Termination for Multiple Accounts</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.6.3. Prohibition on Sharing Accounts</h4>
        <p className="pl-6">
        ...
        <p className="pl-6">
          ...
          outworkx&apos;s right to include or exclude you from these tests at
          any time without prior notice. Furthermore, you agree that outworkx
          may take actions it deems reasonably necessary to prevent fraud and
          abuse on the Platform.
        </p>

        <h3 className="pl-4">2.7. User Information</h3>

        <h4 className="pl-6">2.7.1. Accuracy of Information</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.7.2. Password Creation</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.7.3. Mobile Application Access</h4>
        <p className="pl-6">
          Using some or all of outworkx&apos;s features may require downloading
          a mobile application. You are responsible for providing your own
          device (computer, mobile phone), internet connection, and any other
          necessary means to access the Platform and any related services.
        </p>

        <h3 className="pl-4">2.8. Eligibility</h3>

        <h4 className="pl-6">2.8.1. Geographic Restrictions</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.8.2. Age Requirement</h4>
        <p className="pl-6">
          You must be at least 18 years old to use the Platform and/or purchase
          a subscription.
        </p>

        <h4 className="pl-6">2.8.3. Right to Deny Access</h4>
        <p className="pl-6">
        ...
        <h3 className="pl-4">2.9. Communications</h3>

        <h4 className="pl-6">2.9.1. Consent to Communication</h4>
        <p className="pl-6">
        ...
        <h4 className="pl-6">2.9.2. Marketing Opt-Out</h4>
        <p className="pl-6">
        ...
        <h3 className="pl-4">2.10. Subscribing Organizations</h3>

        <h4 className="pl-6">
          2.10.1. Authorization for Organizational Accounts
        </h4>
        <p className="pl-6">
          If you are opening or using an outworkx account on behalf of a
          company, organization, or other entity (a &quot;Subscribing
          Organization&quot;), you represent and warrant that you are an
          authorized representative of the organization with the legal authority
          to bind such organization to these Terms.
        </p>

        <h4 className="pl-6">2.10.2. Binding Agreement</h4>
        <p className="pl-6">
      ...
      <div>
        <h2 className="mt-5">3. Fees, Billing and Cancellation</h2>

        <h3 className="pl-4">3.1. Recurring Billing and Subscription Cycle:</h3>
        <p className="pl-6">
          <strong className="text-black">3.1.1.</strong> Your outworkx
          subscription is a recurring service. By initiating a subscription, you
          authorize outworkx to charge you for your initial subscription period
          and a recurring monthly subscription fee at the then-current rate.
          This rate may change at any time.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.1.2.</strong> You acknowledge that
          the monthly billed amount may vary due to promotional offers, plan
          changes, or add-ons. You authorize outworkx to charge your designated
          payment method for these varying amounts, which may be billed monthly
          in one or more charges.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.1.3.</strong> You are responsible for
          all subscription fees until you cancel your subscription or it is
          otherwise terminated, even if you do not use the subscription or
          access the platform.
        </p>

        <h3 className="pl-4">3.2. Automatic Renewal:</h3>
        <p className="pl-6">
          <strong className="text-black">3.2.1.</strong> Upon signing up and
          purchasing your outworkx subscription, your first subscription cycle
          will be billed immediately.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.2.2.</strong> Unless otherwise
          communicated, your subscription will automatically renew each month,
          and you will be billed on the same date each month. outworkx reserves
          the right to adjust billing timing, with appropriate adjustments made
          to charged amounts.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.2.3.</strong> In some cases, your
          billing date may fall on a day not present in a given month. In such
          scenarios, outworkx may bill your payment method on a designated day
          within that month, deemed appropriate by outworkx. (e.g., Starting
          your membership on January 31st may result in a February 28th billing
          date.) Your renewal date may change due to subscription modifications.
        </p>

        <h3 className="pl-4">3.3. Refunds:</h3>
        <p className="pl-6">
          <strong className="text-black">3.3.1.</strong> outworkx fees,
          including the monthly subscription fee and any other charges, are
          generally non-refundable. Exceptions may exist if explicitly
          communicated at the time of purchase.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.3.2.</strong> However, subscribers
          may be eligible for a refund of their current prepaid subscription
          period if their subscription is cancelled before the end of the
          charged period due to relocation, disability, or death. outworkx
          reserves the right to: (a) Charge a fee to cover the cost of utilized
          Venues, services, or products before cancellation. (b) Request proof
          of the changed condition, as permitted by law.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.3.3.</strong> outworkx does not
          provide refunds or credits for prior months, including unused credits
          or memberships.
        </p>

        <h3 className="pl-4">3.4. Price Changes:</h3>
        <p className="pl-6">
          <strong className="text-black">3.4.1.</strong> outworkx reserves the
          right to adjust pricing at any time. Unless explicitly communicated
          otherwise, any price changes to your subscription will be effective on
          your next billing cycle after notice is provided. This notice may be
          communicated through a posting on the outworkx platform or mobile
          application, or through other appropriate means such as email.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.4.2.</strong> If you do not cancel
          your subscription after receiving notice of a price change, you are
          deemed to have accepted the new fees.
        </p>

        <h3 className="pl-4">3.5. Payment Methods:</h3>
        <p className="pl-6">
          <strong className="text-black">3.5.1.</strong> You can edit your
          payment method information by logging into your account settings on
          the platform or mobile application.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.5.2.</strong> If a payment fails due
          to expiration, insufficient funds, or other reasons, you remain
          responsible for any uncollected amounts. You authorize outworkx to
          continue billing the provided payment method (or any updated method)
          even when attempting to create a new account, reactivate a past
          account, or sign up for a new account. This may result in adjustments
          to your payment billing dates.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.5.3.</strong> outworkx reserves the
          right to terminate your access to the platform or any portion thereof
          if your account cannot be charged. However, outworkx is not obligated
          to do so.
        </p>

        <h3 className="pl-4">3.6. Subscription Cancellation:</h3>
        <p className="pl-6">
          <strong className="text-black">3.6.1.</strong> Unless otherwise
          communicated, you can cancel your subscription at any time before your
          renewal by accessing your account settings on the outworkx platform
          and indicating your desire to cancel.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.6.2.</strong> Following any
          cancellation, you will continue to have access to your subscription
          through the end of your current prepaid subscription cycle, unless you
          cancel and receive a refund, in which case your access will be
          terminated immediately.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.6.3.</strong> Cancelling your
          subscription (or having it terminated) will result in the loss of
          access to all Venues, content, credits, or features available through
          the subscription.
        </p>

        <h3 className="pl-4">3.7. Reservation and Cancellation of Bookings:</h3>
        <p className="pl-6">
          <strong className="text-black">3.7.1.</strong> All bookings on the
          outworkx platform must be reserved and cancelled exclusively through
          the platform. Reserving or cancelling directly with a Venue (including
          through their online or mobile account) constitutes a breach of these
          Terms.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.7.2.</strong> If you reserve or
          cancel directly with a Venue, outworkx reserves the right to: (a)
          Charge you the full booking amount charged by the Venue and any
          applicable cancellation fees. (b) Suspend or terminate your
          subscription.
        </p>

        <h3 className="pl-4">3.8. Fees Charged by Venues:</h3>
        <p className="pl-6">
          <strong className="text-black">3.8.1.</strong> In addition to outworkx
          fees, Venues may also charge separate fees for equipment or other
          amenities. You are responsible for these additional charges directly
          to the Venue.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.8.2.</strong> outworkx only grants
          access to the specific Venue and time/location booked on the platform.
          The Venue may have additional fees for using other spaces.
        </p>

        <h3 className="pl-4">3.9. Third-Party Fees for Using outworkx:</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">3.10. Credit Rollover:</h3>
        <p className="pl-6">
          <strong className="text-black">3.10.1.</strong> As long as you remain
          an active outworkx user with a paid subscription, you can roll over
          unused credits, up to the total number of credits included in your
          current plan.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.10.2.</strong> For example, with a
          25-credit plan renewal, you can roll over up to 25 unused credits to
          your next subscription cycle.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.10.3.</strong> Additionally, if you
          have a 25-credit plan and purchase an additional 50 credits (but
          don&apos;t use them), only a maximum of 25 credits will roll over to
          the next cycle.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.10.4.</strong> It is important to
          note that rollovers are not cumulative. Credits only roll over from
          one month to the next and do not accumulate over multiple months.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.10.5.</strong> Trial periods do not
          allow for credit rollover. outworkx may offer different rollover
          policies for specific promotions.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.10.6.</strong> Please be aware that
          rolled-over credits may take up to 48 hours to appear in your account
          after renewal.
        </p>
        <p className="pl-6">
          <strong className="text-black">3.10.7.</strong> If you cancel or
          delete your account, all remaining credits will be forfeited on the
          date of deletion.
        </p>
      </div>
      <div>
        <h2 className="mt-5">4. Promotions</h2>

        <h3 className="pl-4">4.1. Trials</h3>
        <p className="pl-4">
        ...
        <h4 className="pl-6">4.1.1. Trial Terms and Conditions:</h4>
        <p className="pl-8">
          <strong className="text-black">4.1.1.1.</strong> Trials, discount
          offers, and promotions (collectively, &quot;Trials&quot;) are subject
          to specific terms and conditions outlined for each promotion. These
          terms may differ from the general Terms of Use.
        </p>
        <p className="pl-8">
          <strong className="text-black">4.1.1.2.</strong> Trials are not
          transferable, cannot be combined with other offers, cannot be redeemed
          for cash, and are void where prohibited.
        </p>
        <p className="pl-8">
          <strong className="text-black">4.1.1.3.</strong> You acknowledge and
          agree that Trials are generally only available to new users who have
          never had a previous outworkx account. Only one trial is permitted per
          user or payment method. Creating multiple accounts or attempting to
          sign up for a trial after having previously had an account constitutes
          a violation of these Terms.
        </p>
        <p className="pl-8">
          <strong className="text-black">4.1.1.4.</strong> outworkx reserves the
          absolute right to determine your eligibility for a trial. If we
          believe you are ineligible, we may prevent you from signing up or
          terminate your promotional subscription and automatically charge you
          for any usage during the ineligible trial period.
        </p>
        <p className="pl-8">
          <strong className="text-black">4.1.1.5.</strong> In the event your
          trial is terminated due to a violation of these Terms, you understand
          that you will not be eligible for a refund.
        </p>

        <h3 className="pl-4">4.2. Refer a Friend</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">4.3. Additional Promotions</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">5. Termination or Modification</h2>

        <h3 className="pl-4">5.1. Termination by Outworkx</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">5.2. Refund Policy</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">
          5.3. No Liability for Termination or Modification
        </h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">5.4. Prohibition on Re-registration</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">6. Privacy Policy</h2>

        <h3 className="pl-4">6.1. Incorporation by Reference</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">6.2. Information Sharing with Venue Partners</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">6.3. Compliance with Privacy Policy</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">6.4. Questions and Concerns</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">7. Prohibited Activities</h2>

        <h3 className="pl-4">7.1. Harassment and Disruption</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">7.2. Deceptive and Fraudulent Behavior</h3>
        <p className="pl-4">
          Deceptive or fraudulent actions, such as impersonation, accessing
          another user&apos;s account without authorization, or maintaining
          multiple accounts, are strictly prohibited. Users are also prohibited
          from sharing Outworkx passwords with third parties.
        </p>

        <h3 className="pl-4">7.3. Misuse of Memberships and Services</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">7.4. Unauthorized Use and Exploitation</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">7.5. Malicious Activities</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">7.6. Technical Interference</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">7.7. Unauthorized Access and Spam</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">7.8. Compliance with Terms</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">8. User-Generated Content</h2>

        <h3 className="pl-4">8.1. General</h3>
        <p className="pl-4">
          ...
          connections, and other user-generated content (&quot;User
          Submissions&quot;). User Submissions encompass reviews, ratings, and
          feedback provided by users. It is essential for users to exercise
          caution and discretion when uploading content to the platform.
          Outworkx does not guarantee anonymity or confidentiality regarding
          User Submissions. For information regarding the handling of personal
          information, please refer to our Privacy Policy.
        </p>

        <h3 className="pl-4">8.2. Reviews</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">8.3. Right to Manage User Submissions</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">8.4. License Grant</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">8.5. Representations and Warranties</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">8.6. Exposure to User Submissions</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">8.7. Feedback</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">8.8. Enforcement Against Infringing Activity</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">8.9. Venue Ratings</h3>
        <p className="pl-4">
          Users may be prompted to rate venues or Outworkx experiences they have
          reserved.
        </p>

        <h3 className="pl-4">8.10. Advertising</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">9. Ownership and Intellectual Property</h2>

        <h3 className="pl-4">9.1. Ownership of Platform and Content</h3>
        <p className="pl-4">
          ...
          referred to as &quot;Content&quot;) provided by Outworkx through the
          Platform are protected by copyright, trade dress, patent, trademark,
          and other intellectual property laws. Unless otherwise stated, all
          Content, excluding User Submissions, is the copyrighted property of
          Outworkx or its affiliated entities and/or third-party licensors.
          Trademarks, service marks, and trade names associated with Outworkx
          are the property of Outworkx or its affiliates and/or third-party
          licensors.
        </p>

        <h3 className="pl-4">9.2. Permissible Use of Content</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">9.3. Software Usage and Restrictions</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">9.4. Personal Use and Redistribution</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">9.5. Rights of Content Owners</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">9.6. Disclaimers and Limitations of Liability</h3>
        <p className="pl-4">
          Outworkx and Content owners provide the Platform and Content on an
          &quot;as-is&quot; and &quot;as available&quot; basis without
          warranties of any kind. Neither Outworkx nor Content owners guarantee
          that the Platform or Content are free from viruses or harmful
          components. Under no circumstances shall Outworkx or Content owners be
          liable for incidental, punitive, special, or consequential damages
          arising from Platform use or Content accessibility, or for damages
          exceeding the amount paid for the specific Content item giving rise to
          the claim.
        </p>
      </div>
      <div>
        <h2 className="mt-5">10. Third-party Platforms and Services</h2>

        <h3 className="pl-4">10.1. Linked Platforms Disclaimer</h3>
        <p className="pl-4">
          The Outworkx Platform may provide links or access to third-party web
          Platforms or services (&quot;Linked Platforms&quot;) for user
          convenience. Outworkx does not pre-screen, monitor, or endorse any
          Linked Platforms or the information, material, products, or services
          they contain. Outworkx makes no express or implied warranties
          regarding the accuracy, reliability, or quality of information,
          material, products, or services on Linked Platforms. Users access and
          utilize Linked Platforms, including their content and services, at
          their own risk.
        </p>

        <h3 className="pl-4">
          10.2. Promotional Plans and Third-party Products
        </h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">10.3. Dealings with Third Parties</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">11. Electronic Signature Acceptance</h2>

        <h3 className="pl-4">11.1. Legally Binding Agreement</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">11.2. Use of Electronic Signatures</h3>
        <p className="pl-4">
          ...
          waive any rights or requirements under any jurisdiction&apos;s
          statutes, regulations, rules, ordinances, or other laws that
          necessitate an original signature, or non-electronic delivery or
          retention of records. You also waive any requirements for payments or
          credits to be granted by means other than electronic methods.
        </p>
      </div>
      <div>
        <h2 className="mt-5">12. Disclaimer of Liability</h2>

        <h3 className="pl-4">12.1. Third-Party Products and Services</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">12.2. Third-Party Liability</h3>
        <p className="pl-4">
          ...
          arising from a user&apos;s attendance, use, or participation in a
          product, or the performance or non-performance of any third party.
          Outworkx acts independently and is not an agent of any third party.
        </p>

        <h3 className="pl-4">12.3. No Warranty of Content or Features</h3>
        <p className="pl-4">
          All aspects, content, or features available through the Platform are
          provided &quot;as is&quot; and &quot;as available&quot; without any
          warranties of any kind, either express or implied. Outworkx, on behalf
      ...
      <div>
        <h2 className="mt-5">13. Understanding of Risks</h2>

        <h3 className="pl-4">13.1. Assumption of Risks</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">13.2. Release and Indemnification</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">14. Indemnification Agreement</h2>
        <p>
      ...
      <div>
        <h2 className="mt-5">15. Limitation of Liability</h2>
        <p>
          ...
          APPLY TO YOU. IN SUCH CASES, OUTWORKX&apos;S LIABILITY WILL BE LIMITED
      ...
      <div>
        <h2 className="mt-5">16. Venue Agreements and Terms</h2>
        <p>
      ...
      <div>
        <h2 className="mt-5">17. Copyright and Trademark Policies</h2>
        <p>
      ...
      <div>
        <h2 className="mt-5">18. Class Action Waiver</h2>
        <p>
        ...
        <h3 className="mt-2 pl-4">18.1. Continuation of Class Action Waiver</h3>
        <p className="pl-4">
      ...
      <div>
        <h2 className="mt-5">19. Miscellaneous</h2>
        <h3 className="pl-4">19.1. Choice of Law; Forum</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">19.2. Assignment</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">19.3. Severability</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">19.4. Headings</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">19.5. Entire Agreement</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">19.6. Claims; Statute of Limitations</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">19.7. Waiver</h3>
        <p className="pl-4">
        ...
        <h3 className="pl-4">19.8. Notice</h3>
        <p className="mb-6 pl-4">
          Unless explicitly stated otherwise, legal notices shall be served to
          outworkx&apos;s national registered agent and to you at the email
          address provided during the registration process. Notice shall be
          deemed given 24 hours after email transmission, unless the sender is
          notified of an invalid email address. Alternatively, legal notice may
          be given by mail to the address provided during registration, with
          notice deemed given three days after the date of mailing.
        </p>
      </div>
      <Footer />
    </>
