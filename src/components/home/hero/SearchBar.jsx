export default function SearchBar() {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center  gap-2 sm:bg-gray bg-transparent rounded-full p-2.5 w-full sm:max-w-24 mx-auto lg:max-w-4xl">
